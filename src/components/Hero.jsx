...
const Hero = () => {
  return (
    <div className='flex flex-col justify-center items-center h-full bg-custom-green   '>
        <div className="text-4xl text-text-color flex flex-col justify-center items-center py-4">
           <p>Your Trusted Partner for </p> 
            <span className="font-bold">Tax & Compliance</span>
        </div>
        <div className="flex relative ">
            <input className="w-[450px] h-[35px] rounded-lg pl-8 pb-1" placeholder="Search for..."/>
            <CiSearch className="absolute right-5 top-[5px] text-2xl text-slate-400 "/>
        </div>
        <div className="py-4 text-dark-gray-transparent">
            Focus on your growth while we handle your tax and compliance on time.
        </div>
        <div className="bg-white flex w-[1015px] h-[90px] rounded-xl">
        ...
        <div className="w-[1015px] h-[270px] flex flex-row rounded-xl mt-6 mb-6">
            <div className="w-1/3 h-full bg-white  rounded-xl flex flex-col  items-center mb-4">
                <div className="mt-16">
            ...
            <div className="w-1/3 h-full bg-white  rounded-xl mx-8 flex flex-col  items-center mb-4">
