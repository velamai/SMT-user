...
const Footer2 = () => {
    return (
        <div className='bg-Footergreen h-[500px] w-full flex flex-col pt-8 gap-5 pl-[250px]'>
            ...
            <div className="mt-5 flex flex-row gap-12">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex gap-2 ">
                        <Image src="/images/germany.png" width={25} height={10} alt="germany" />
