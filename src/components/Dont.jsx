...
const Dont = () => {
    return (
        <div className='mt-[50px] w-full h-[580px] flex flex-col bg-gray-100'>
            <div className="w-full h-1/2 px-[250px] bg-white mt-8 pt-4 gap-6 flex flex-col">
                <p className="text-lg font-bold">Numbers Don&apos;t Lie!</p>
                <div className="flex flex-row gap-7">
                    <div className="w-1/2 h-[125px] border-2 border-orange-500 flex flex-col gap-3 p-3 rounded-xl">
                    ...
                    <div className="w-1/2 h-[125px] border-2  border-red-500 flex flex-col gap-3 p-3 rounded-xl">
                        <p className="text-4xl font-bold">90</p>
                        <p>We touched 1000+ customer in just a month of our<br />operations</p>
                    </div>
                </div>
            </div>
            <div className="flex flex-col px-[250px] w-full h-1/2 bg-gray-100 gap-7">
                <p className="text-lg font-bold pt-2">For you</p>
                <div className="flex flex-row gap-8">
                    <div className="w-1/3 h-full border-2 border-gray-300 p-3 rounded-xl bg-white">
